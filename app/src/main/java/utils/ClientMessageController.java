...
class ClientMessageReceiver implements Runnable {
                    ...
                    if (read.endsWith("}")) {
                        ...
                        if (getConnectionStat() == 0) {
                            ...
                            if (cgm != null && Objects.equals(cgm.id(), ClientMessageController.SERVER_ID)) {
                                ...
                                ClientMessageController.sendMessageToServer(new Message(ClientMessageController.clientId, "", MainActivity.MSG_LEN, supportMode));
                                // 进入接受传输模式
    ...
    private static void messageFeedBack() {
        ...
        ClientMessageController.sendMessageToServer(new Message(ClientMessageController.clientId, null,
                ClientMessageController.MSG_LEN, ClientMessageController.FB_MSG));
    }
